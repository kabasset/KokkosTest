...
{
  Linx::Position<2> shape {2, 4};
  BOOST_TEST(Linx::Shape(shape).size() == 8);
  check_ctor(Linx::Box(), Linx::GBox<int, 0>());
  check_ctor(Linx::Box({-1}, {1}), Linx::GBox<int, 1>({-1}, {1}));
  check_ctor(Linx::Box({-1, -2}, {1, 2}), Linx::GBox<int, 2>({-1, -2}, {1, 2}));
  check_ctor(Linx::Box({-1, -2}, Linx::Shape({2, 4})), Linx::GBox<int, 2>({-1, -2}, {1, 2}));
  check_ctor(Linx::Box({-1, -2}, Linx::Shape(shape)), Linx::GBox<int, 2>({-1, -2}, {1, 2}));
